import{j as P,l as y,a5 as l,a6 as $,O as _,x as u,M as C,z as I,Y as F,w as E,y as z,W as M,R as W,v as U,H as Y,T as K,D as B}from"./index-K-roXM5G.js";import{o as m,r as c,c as b,n as p}from"./if-defined-CZsWIg_F.js";import"./index-JM0W_DnB.js";import{O as j}from"./index-_DddjQlv.js";import"./index-BkSKb87B.js";import"./index-1ukh8Xp5.js";import"./index-BXZCl2Cq.js";import"./index-ZJw0zqVh.js";import"./index-C5jwKiJe.js";import"./index-BKGQWzCJ.js";import"./index-C1JBQxHX.js";import"./index-ek7vsds7.js";import"./ref-VM7PWGVm.js";import"./ConstantsUtil-Dmg8YACJ.js";const N=P`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
  }
...
`;var A=function(s,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(s,e,t,r);else for(var a=s.length-1;a>=0;a--)(n=s[a])&&(i=(o<3?n(i):o>3?n(e,t,i):n(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let R=class extends y{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=l.state.paymentCurrency,this.currencies=l.state.paymentCurrencies,this.currencyImages=$.state.currencyImages,this.checked=j.state.isLegalCheckboxChecked,this.unsubscribe.push(l.subscribe(e=>{this.selectedCurrency=e.paymentCurrency,this.currencies=e.paymentCurrencies}),$.subscribeKey("currencyImages",e=>this.currencyImages=e),j.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var a;const{termsConditionsUrl:e,privacyPolicyUrl:t}=_.state,r=(a=_.state.features)==null?void 0:a.legalCheckbox,n=!!(e||t)&&!!r&&!this.checked;return u`
    ...
    `}currenciesTemplate(e=!1){return this.currencies.map(t=>{var r;return u`
      ...
      `})}selectCurrency(e){e&&(l.setPaymentCurrency(e),C.close())}};R.styles=N;A([c()],R.prototype,"selectedCurrency",void 0);A([c()],R.prototype,"currencies",void 0);A([c()],R.prototype,"currencyImages",void 0);A([c()],R.prototype,"checked",void 0);R=A([b("w3m-onramp-fiat-select-view")],R);const q=P`
  button {
...
`;var Q=function(s,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(s,e,t,r);else for(var a=s.length-1;a>=0;a--)(n=s[a])&&(i=(o<3?n(i):o>3?n(e,t,i):n(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let D=class extends y{render(){const{termsConditionsUrl:e,privacyPolicyUrl:t}=_.state;return!e&&!t?null:u`
      <wui-flex
        .padding=${["m","s","s","s"]}
        flexDirection="column"
        alignItems="center"
    ...
    `}howDoesItWorkTemplate(){return u` <wui-link @click=${this.onWhatIsBuy.bind(this)}>
      ...
      How does it work?
    </wui-link>`}onWhatIsBuy(){E.sendEvent({type:"track",event:"SELECT_WHAT_IS_A_BUY",properties:{isSmartAccount:z(I.state.activeChain)===M.ACCOUNT_TYPES.SMART_ACCOUNT}}),W.push("WhatIsABuy")}};D.styles=[H];D=Q([b("w3m-onramp-providers-footer")],D);var V=function(s,e,t,r){var o=arguments.length,i=o<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(s,e,t,r);else for(var a=s.length-1;a>=0;a--)(n=s[a])&&(i=(o<3?n(i):o>3?n(e,t,i):n(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let S=class extends y{constructor(){super(),this.unsubscribe=[],this.providers=l.state.providers,this.unsubscribe.push(l.subscribeKey("providers",e=>{this.providers=e}))}render(){return u`
