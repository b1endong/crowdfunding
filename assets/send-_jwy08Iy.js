import{j as f,l as w,v as I,z as x,H,X as l,x as u,q as z,F as W,R as g,V as L,Y as q,D as B,w as F,y as M,W as Y}from"./index-K-roXM5G.js";import{n as d,r as c,c as m,U as b,o as K}from"./if-defined-CZsWIg_F.js";import"./index-C5jwKiJe.js";import"./index-BKGQWzCJ.js";import{e as O,n as D}from"./ref-VM7PWGVm.js";import{n as X,s as G}from"./ConstantsUtil-Dmg8YACJ.js";import"./index-ZJw0zqVh.js";import{S as J}from"./index-BqVg1Uf7.js";import"./index-ek7vsds7.js";import"./index-BZWh45Gp.js";import"./index-tfbJfLts.js";import"./index-BkSKb87B.js";import"./index-1ukh8Xp5.js";const Q=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var j=function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var a=o.length-1;a>=0;a--)(s=o[a])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let C=class extends w{constructor(){super(...arguments),this.inputElementRef=O(),this.disabled=!1,this.value="",this.placeholder="0"}render(){var e;return(e=this.inputElementRef)!=null&&e.value&&this.value&&(this.inputElementRef.value.value=this.value),u`<input
    ...
    /> `}dispatchInputChangeEvent(e){var n,r;const i=e.data;if(i&&((n=this.inputElementRef)!=null&&n.value))if(i===","){const t=this.inputElementRef.value.value.replace(",",".");this.inputElementRef.value.value=t,this.value=`${this.value}${t}`}else X.test(i)||(this.inputElementRef.value.value=this.value.replace(new RegExp(i.replace(G,"\\$&"),"gu"),""));this.dispatchEvent(new CustomEvent("inputChange",{detail:(r=this.inputElementRef.value)==null?void 0:r.value,bubbles:!0,composed:!0}))}};C.styles=[z,W,Z];j([d({type:Boolean})],C.prototype,"disabled",void 0);j([d({type:String})],C.prototype,"value",void 0);j([d({type:String})],C.prototype,"placeholder",void 0);C=j([m("wui-input-amount")],C);const ee=f`
  :host {
    width: 100%;
    height: 100px;
    border-radius: var(--wui-border-radius-s);
