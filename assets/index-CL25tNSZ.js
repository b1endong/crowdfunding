import{_ as $,a3 as _,a4 as R,j as f,q as m,l as b,x as l,O as s,F as O}from"./index-DC_CUsqb.js";import{n as j,c as w,o as P,r as y}from"./if-defined-C8uQVURo.js";import{e as T,n as U}from"./ref-DmDf9tn6.js";import{R as B}from"./ConstantsUtil-Dmg8YACJ.js";const u=$({isLegalCheckboxChecked:!1}),g={state:u,subscribe(n){return R(u,()=>n(u))},subscribeKey(n,e){return _(u,n,e)},setIsLegalCheckboxChecked(n){u.isLegalCheckboxChecked=n}},E=f`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
